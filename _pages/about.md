...
<div class="bio-section">
  ...
  <p>
    I have multiple industrial internship experiences including <a href="https://ai.tencent.com/ailab/en/about/" target="_blank" rel="noopener"><img class="org-icon" src="{{ '/assets/img/icons/tencent.png' | prepend: site.baseurl | prepend: site.url }}" alt="">Tencent AI Lab</a> (2022), <a href="https://www.apple.com/siri/" target="_blank" rel="noopener"><img class="org-icon" src="{{ '/assets/img/icons/apple.png' | prepend: site.baseurl | prepend: site.url }}" alt="">Apple Siri Information and Intelligence Team</a> (2023), <a href="https://mitibmwatsonailab.mit.edu" target="_blank" rel="noopener"><img class="org-icon" src="{{ '/assets/img/icons/ibm.png' | prepend: site.baseurl | prepend: site.url }}" alt="">MIT-IBM Watson AI Lab</a> (2024), <a href="https://allenai.org/" target="_blank" rel="noopener"><img class="org-icon" src="{{ '/assets/img/icons/ai2.png' | prepend: site.baseurl | prepend: site.url }}" alt="">Allen Institute for AI (Ai2)</a> (2025), and <a href="https://ai.meta.com/" target="_blank" rel="noopener"><img class="org-icon" src="{{ '/assets/img/icons/meta.png' | prepend: site.baseurl | prepend: site.url }}" alt="">Meta AI</a> (2026). All focusing on language modeling and its applications.
  </p>
</div>
